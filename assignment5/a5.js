...
document.getElementById("output").innerHTML += "Ascending order: " + sortedNumbersAsc.join(", ") + "<br>";

const sortedNumbersDesc = sortArray(numbers, "desc");
console.log("Sorted Array: ", sortedNumbersDesc);
document.getElementById("output").innerHTML += "Descending order: " + sortedNumbersDesc.join(", ") + "<br>";
