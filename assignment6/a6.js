...
console.log("Your highest rated movie is: " + bestMovie.title + " with a rating of " + bestMovie.rating);
document.getElementById("output").innerHTML += "Your highest rated movie is: " + bestMovie.title + " with a rating of " + bestMovie.rating + "<br>";

console.log("Movies sorted by rating: ", movies);
document.getElementById("output").innerHTML += "Movies sorted by rating: <br>";
movies.forEach(movie => {
    document.getElementById("output").innerHTML += movie.title + " - " + movie.rating + "<br>";
});
